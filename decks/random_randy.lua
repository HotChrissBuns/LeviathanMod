...
SMODS.Back {
    ...
    loc_txt = {
        name = 'Random Randy',
        text = {
            [1] = 'All cards have random {C:attention}Suits{} , {C:attention}Ranks{} , {C:enhanced}Enhancements{} , {C:attention}Seals{} and {C:dark_edition}Editions{}',
            [2] = 'also start with{C:attention} 5{} random{C:attention} jokers{}'
        },
    },
    unlocked = true,
    discovered = true,
